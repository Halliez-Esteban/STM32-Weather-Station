 ...
 * Modified to include weather monitoring by Esteban Halliez in 2026.
 *
...
void ssd1306_WriteHumid(int32_t temp_int,uint32_t temp_dec);
void ssd1306_WritePress(int32_t temp_int,uint32_t temp_dec);
